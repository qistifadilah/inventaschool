            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" id="nama_jenis" class="form-control" name="nama_jenis"
                        placeholder="Masukan Nama Jenis" value="{{ $jeni->nama_jenis }}">
                </div>
                <div class="form-group">
                    <label for="kode_jenis">Kode Jenis</label>
                    <input type="text" id="kode_jenis" class="form-control" name="kode_jenis"
                        placeholder="Masukan Kode Jenis" value="{{ $jeni->kode_jenis }}">
                </div>
                <div class="form-group">
                    <label for="keterangan">Keterangan</label>
                    <textarea id="keterangan" class="form-control" name="keterangan" placeholder="Masukan Keterangan">{{ $jeni->keterangan }}</textarea>
                </div>
            </div>
